...
@section('content')
    ...
    @if ($manage)
        <div class="text-center">
            <a href="{{ route('promotions.create') }}">
                <button type="submit" class="btn btn-primary text-light mb-4 mt-2 btn-lg w-75">Nova promoção</button>
            </a>
        </div>
    @endif
    @if ($errors->any())
        ...
        @endforeach
    @endif
    {{--    @if ($catId==0 && is_array($promotions) && !empty($query))--}}
    {{--            <?php--}}
    {{--            $url = request()->url() . '?';--}}
    ...
    {{--                           href="{{ ($price=='500-1000')?'#':$withoutPrice.'&price=500-1000' }}">500 ---}}
    {{--                        1000</a>--}}
    {{--                    </li>--}}
    {{--                    <li>--}}
