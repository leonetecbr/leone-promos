...
@section('content')
    <article class="container">
        ...
        <div id="notification-blocked" class="d-none">
            ...
            <p>Você bloqueou as nossas notificações, mas calma você pode desbloquear facilmente, basta seguir os passos
                informados abaixo.</p>
            <div class="text-center">
                <img src="{{ url('/img/ajuda/desbloquear-notificacoes-browser.png') }}"
                     alt="Menu de configurações de sites no Google Chrome"/>
                <p class="my-3 text-muted">Clique no cadeado e procure por "Notificações" se estiverem bloqueadas ou
                    desativadas como na imagem, ative ou escolha "Sempre permitir", recarregue a página e tente ativar
                    novamente.</p>
            </div>
        </div>
        ...
        <div id="notification-unsupported" class="d-none">
            ...
            <div class="accordion mw-700 mx-auto fs-5 text-center">
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingIg">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                data-bs-target="#collapseIg" aria-expanded="false" aria-controls="collapseIg">Está no
                            Instagram ou outra rede social ?
                        </button>
                    </h2>
                    <div id="collapseIg" class="accordion-collapse collapse" aria-labelledby="headingIg"
                         data-bs-parent="#notification-unsupported">
                        <div class="accordion-body">
                            <h3 class="fw-light mb-3">Siga esses passo para conseguir ativar!</h3>
                            <img src="{{ url('/img/ajuda/barra-navegador-instagram.jpg') }}"
                                 alt="Barra do navegador integrado do Instagram">
                            <p class="my-3 text-muted">Clique nos "3 pontinhos" para acessar mais opções do navegador do
                                Instagram.</p>
                            <img src="{{ url('/img/ajuda/abrir-no-navegador-instagram.jpg') }}"
                                 alt="Menu da barra do navegador integrado do Instagram">
                            <p class="my-3 text-muted">Agora clique em "Abrir no Chrome" ou no navegador de sua
                                preferência.</p>
                        </div>
                    </div>
                </div>
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingIg">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                data-bs-target="#collapseBrowser" aria-expanded="false" aria-controls="collapseBrowser">
                            Está num navegador comum ?
                        </button>
                    </h2>
                    <div id="collapseBrowser" class="accordion-collapse collapse" aria-labelledby="headingBrowser"
                         data-bs-parent="#notification-unsupported">
                        <div class="accordion-body">
                            ...
                            <p>Se você já está usando um desses navegadores, verifique se há atualizações
                                disponíveis.</p>
                        </div>
                    </div>
                </div>
