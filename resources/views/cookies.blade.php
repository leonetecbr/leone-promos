...
@section('content')
    <article class="container">
        ...
        <p>
            Como é prática comum em quase todos os sites profissionais, este site usa cookies, pequenos arquivos
            baixados no seu computador, para melhorar sua experiência. Esta página descreve quais informações eles
            armazenam, como os usamos e por que às vezes precisamos armazenar esses cookies. Também compartilharemos
            como você pode impedir que esses cookies sejam armazenados, no entanto, isso pode fazer o <i>downgrade</i>
        ...
        <p>
            Utilizamos cookies por vários motivos, detalhados abaixo. Infelizmente, geralmente, não existem opções
            padrão do setor para desativar os cookies sem desativar completamente a funcionalidade e os recursos que
            eles adicionam a este site. É recomendável que você deixe todos os cookies se não tiver certeza se precisa
        ...
        <ul>
            ...
            <li>
                ...
                <p>
                    São cookies que servem para proteger nossos usuários de ataques CSRF, sigla em inglês para
                    <span class="fw-bolder">Falsificação de solicitação entre sites.</span>
                </p>
            </li>
            <li>
                <p class="fw-bolder">
                ...
                <p>
                    São usados para guardar sua sessão, por exemplo, quando você faz <i>login</i>, não é necessário você
                    digitar sua senha a cada ação, porque o <i>cookie</i> de sessão já identifica você.
                </p>
            </li>
        </ul>
        <h2 class="display-6">
        ...
        <ul>
            <li>
                Este site usa o Google Analytics, uma das soluções de análise mais difundidas e confiáveis da Web, para
        ...
        <ul>
            <li>
                O serviço Google AdSense que usamos para veicular publicidade usa um <i>cookie</i> DoubleClick para
        ...
        <p>
            Quer saber mais sobre como usamos os dados que temos acesso ou como você pode excluir seus dados? Consulte as
            nossas <a href="{{ route('privacidade') }}">Políticas de Privacidade</a>.
        </p>
        <h2 class="display-6">
            Mais informações
        </h2>
