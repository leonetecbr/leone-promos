            ...
            <div class="row">
                ...
                <div class="col-8">
                    <input type="text" id="name" name="title" class="form-control" required
                           placeholder="Digite o título da notificação ..." value="{{ old('title') }}"/>
                </div>
            </div>
            <div class="row mt-3">
                <div class="col-auto">
                ...
                <div class="col-8">
                    <input type="text" id="image" name="image" class="form-control"
                           placeholder="Digite o link da imagem. Ex: /img/icon.png ..." value="{{ old('image') }}"/>
                </div>
            </div>
            <div class="row mt-3">
                <div class="col-auto">
                ...
                <div class="col-8">
                    <input type="text" id="link" name="link" class="form-control" required
                           placeholder="Digite o link. Ex: /admin ..." value="{{ old('link') }}"/>
                </div>
            </div>
            <div class="form-group mt-3">
                <label for="content" class="mb-2">Conteúdo: </label>
                <textarea name="content" id="content" class="form-control"
                          placeholder="Digite o conteúdo da notificação ..." required>{{ old('content') }}</textarea>
            </div>
            <div class="mt-3">
                <div class="row mb-3">
                    <div class="col-auto">
                    ...
                    <div class="col-8">
                        <input type="number" name="para2" id="para"
                               class="form-control @error('para2') is-invalid @enderror"
                ...
                <div class="container flex-row flex-center row-wrap d-md-flex justify-content-center flex-wrap"
                    ...
                    <div class="form-check col-md-6 col-lg-4">
                        <input type="checkbox" name="para" id="all"
                               class="form-check-input @error('prefer') is-invalid @enderror">
                        <label for="all" class="form-check-label">Todos</label>
                    </div>
                    <div class="form-check col-md-6 col-lg-4">
                        <input type="checkbox" name="p1" id="p1"
                               class="form-check-input prefer @error('prefer') is-invalid @enderror">
                    ...
                    <div class="form-check col-md-6 col-lg-4">
                        <input type="checkbox" name="p8" id="p8"
                               class="form-check-input prefer @error('prefer') is-invalid @enderror">
