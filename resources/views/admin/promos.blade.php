...
<article class="container">
  ...
  <form action="/admin/promos/save" class="p-3 flex-column" method="post" autocomplete="off">
    ...
    <div class="row col-lg-9 mx-auto mt-3"><div class="col-auto"><label for="price">Por: </label></div><div class="col-auto col-lg-9"><input type="number" value="{{ $promo['por']??'' }}" id="price" name="price" class="form-control" required step="0.01" min="-500" placeholder="Digite o preço atual ..."/></div></div>
